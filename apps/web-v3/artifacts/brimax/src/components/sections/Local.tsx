...
const mapEmbedUrl = `https://www.google.com/maps?q=${mapsQuery}&hl=pt-BR&output=embed`;
        ...
        <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)] lg:gap-16">
          <div>
            ...
            <motion.p
              ...
              className="mt-6 max-w-[34rem] text-lg leading-relaxed text-foreground/70 md:mt-8"
            >
              Cerimônia às {event.timeLabel}h, seguida de recepção para celebrarmos juntos.
            </motion.p>
          ...
          >
            <div className="local-v4-map-card relative aspect-[4/3] overflow-hidden rounded-[1.5rem] border border-black/10 bg-[#f5efe6] lg:h-[32rem] lg:aspect-auto">
              <iframe
                src={mapEmbedUrl}
                title={`Mapa de ${event.venue} — ${event.address}`}
