        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground">
              Localize seu convite pelo nome e confirme quem do seu grupo poderá
          ...
          <p className="text-center text-xs text-muted-foreground mt-6">
            Lista de convidados de demonstração. A versão final será conectada
            ao sistema oficial de convites.
          </p>
        </div>
      </div>
    </section>
