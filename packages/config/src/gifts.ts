...
export const PAYMENT_GIFTS: PaymentGift[] = [
  ...
  fractional("g-armario", "Armário de Cozinha", 1749, "armario-cozinha"),
  ...
  fractional("g-cama", "Cama", 1199, "cama"),
  ...
  fractional("g-microondas", "Micro-ondas", 484, "microondas"),
  ...
  single("g-travesseiros", "Travesseiros", 15, "travesseiros")
];
