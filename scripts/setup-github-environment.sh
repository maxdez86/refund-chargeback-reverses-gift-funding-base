...
require_env GITHUB_TOKEN AWS_REGION STAGE ROOT_DOMAIN CONTACT_EMAIL API_DOMAIN WWW_DOMAIN \
  ...
  ASAAS_API_KEY ASAAS_WEBHOOK_TOKEN TURNSTILE_SECRET_KEY TURNSTILE_SITE_KEY GOOGLE_WEB_CLIENT_ID \
  ADMIN_GOOGLE_HOSTED_DOMAIN VITE_ADMIN_SESSION_MODE \
...
set_environment_variable "WHATSAPP_PHONE_NUMBER_ID" "${WHATSAPP_PHONE_NUMBER_ID}"
set_environment_variable "TURNSTILE_SITE_KEY" "${TURNSTILE_SITE_KEY}"
set_environment_variable "GOOGLE_WEB_CLIENT_ID" "${GOOGLE_WEB_CLIENT_ID}"
set_environment_variable "ADMIN_GOOGLE_HOSTED_DOMAIN" "${ADMIN_GOOGLE_HOSTED_DOMAIN}"
set_environment_variable "VITE_ADMIN_SESSION_MODE" "${VITE_ADMIN_SESSION_MODE}"
...
set_environment_secret "WHATSAPP_ACCESS_TOKEN" "${WHATSAPP_ACCESS_TOKEN}"
set_environment_secret "WHATSAPP_APP_SECRET" "${WHATSAPP_APP_SECRET}"
set_environment_secret "WHATSAPP_VERIFY_TOKEN" "${WHATSAPP_VERIFY_TOKEN}"
