...
require_env GITHUB_TOKEN AWS_REGION STAGE ROOT_DOMAIN CONTACT_EMAIL API_DOMAIN WWW_DOMAIN \
  ...
  ASAAS_API_KEY ASAAS_WEBHOOK_TOKEN TURNSTILE_SECRET_KEY TURNSTILE_SITE_KEY VITE_GOOGLE_WEB_CLIENT_ID \
...
set_environment_variable "VITE_GOOGLE_WEB_CLIENT_ID" "${VITE_GOOGLE_WEB_CLIENT_ID}"
