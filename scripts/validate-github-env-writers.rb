...
VARIABLE_KEYS = %w[
  ...
  WHATSAPP_PHONE_NUMBER_ID GOOGLE_WEB_CLIENT_ID ADMIN_GOOGLE_HOSTED_DOMAIN
...
SECRET_KEYS = %w[
  ...
  WHATSAPP_ACCESS_TOKEN WHATSAPP_APP_SECRET WHATSAPP_VERIFY_TOKEN TURNSTILE_SECRET_KEY
