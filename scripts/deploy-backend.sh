...
require_env ASAAS_API_KEY ASAAS_WEBHOOK_TOKEN WHATSAPP_ACCESS_TOKEN WHATSAPP_APP_SECRET \
  WHATSAPP_PHONE_NUMBER_ID WHATSAPP_VERIFY_TOKEN GOOGLE_WEB_CLIENT_ID ADMIN_GOOGLE_HOSTED_DOMAIN
...
printf '  - using CDK-managed Secrets Manager values from ASAAS_API_KEY, ASAAS_WEBHOOK_TOKEN, WHATSAPP_ACCESS_TOKEN, WHATSAPP_APP_SECRET, WHATSAPP_VERIFY_TOKEN, TURNSTILE_SECRET_KEY\n'
